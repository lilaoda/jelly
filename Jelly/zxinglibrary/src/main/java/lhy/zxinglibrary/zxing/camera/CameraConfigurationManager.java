 ...
 */
package lhy.zxinglibrary.zxing.camera;
...
public final class CameraConfigurationManager {
	...
	public void setDesiredCameraParameters(Camera camera, boolean safeMode) {
		...
		//改为摄像头竖直方向 PDA 270 手机90
		String deviceBrand = getDeviceBrand();
		if(TextUtils.equals(deviceBrand,"AUTOID")|| Build.MODEL.indexOf("PDT")==0){
		...
		Log.e("AAAAAAAAAA","degrees:"+degrees);
//
//		int result;
//
